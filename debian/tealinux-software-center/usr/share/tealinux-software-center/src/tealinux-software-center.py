...
class TealinuxSoftwareCenter(object):
    ...
    def initMainWindow(self):
        ...
        # Init.
        window.set_title(__("TeaLinuxOS Software Center"))
    ...
    def cleanDownloadCache(self):
        ...
        partialDir = os.path.join(archiveDir, "tealinux_software_center_cache")
